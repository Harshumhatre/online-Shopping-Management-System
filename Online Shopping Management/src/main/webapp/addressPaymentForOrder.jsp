        ...
        <%
          ...
          <%sno = sno + 1; %>
           <td><%
			...
			<%}
			ResultSet rs2=st.executeQuery("select * from users1 where email='"+email+"'");
			while(rs2.next()){
			%>         
        </tbody>
      </table>
...
<div class="right-div">
<h3>Pay online on this rajuharshad1309@pay.com</h3>
<input class="input-style" type="text" name="p"  placeholder="Enter Transaction Id">
