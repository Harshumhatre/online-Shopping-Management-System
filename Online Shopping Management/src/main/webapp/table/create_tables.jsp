...
try{
	...
	String q1="create table users1(name varchar(100),email varchar(100) primary key,mobileNumber varchar(100),securityQuestion varchar(200),answer varchar(200),password varchar(100),address varchar(500),city varchar(100),state varchar(100),country varchar(100))";
